 ...
 */
public class COLastPDPAddr extends COPDPAddr {
   ...
   */
  public COLastPDPAddr(byte[] addr, short portNo) {
   ...
   */
  public COLastPDPAddr(byte[] addr, short portNo, byte ctype) {
    // currently treat invalid ctype as ipv4. No checking done.
    super(new COHeader((ctype == 2) ? ipv6Length : ipv4Length, LAST_PDP, ctype),
          addr, portNo);
  }
}
