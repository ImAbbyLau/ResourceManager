...
int Mstatus(String pepID,String mysqlURL) {
		...
		try {
			...
			ResultSet res = stmt1.executeQuery("select sindex from LAPEP where LAPEP = '" + pepID + "'");
 ...
 public	int status(String pepID,String mysqlURL) {
