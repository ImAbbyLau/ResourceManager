...
public class BBClient {
	...
	public String browserClient(String sla, String password,String params) throws IOException{
	...
	public void shutdownBB() {
		...
		try {
			...
			Socket bbSocket = new Socket(addy, port);
           	 	...
           	 	BufferedReader in = new BufferedReader(new InputStreamReader(bbSocket.getInputStream()));
